 ...
 * @version 0.1.0
 * @date    20-May-2017
 * @brief   Functions and definitions to interface with the accelerometer + magnetometer chip
 * LSM303DLHC.
 */
#pragma once
...
ret_t rpt_LSM303DLHC_enableStreams(uint8_t *in_p, uint8_t in_len, uint8_t *out_p,
                                   uint8_t *out_len_ptr);
ret_t rpt_LSM303DLHC_changeConfig(uint8_t *in_p, uint8_t in_len, uint8_t *out_p,
                                  uint8_t *out_len_ptr);
...
ret_t rpt_LSM303DLHC_setGainAdjustFlag(uint8_t *in_p, uint8_t in_len, uint8_t *out_p,
                                       uint8_t *out_len_ptr);
